...
% old: child='c:/data/knitr_initial_option_setting_chunk.rnw'
% CLAUDE tpo: 2026-05-14 stale c:/data path; correct location is c:/seiro/settings/Rsetting/knitrPreamble
