excl.base <- "Poor|Size|Trad|With|Cash|InKind|survey|^val|^Excess|^Eff.*R.*nt$|dum.*Tim|^Arm$|BSta"
excla.base <- "^credit|dummy[TC]|Large$|Large\\.|LargeG|Witho|Poor|Small|^Cum|survey|^val|^Excess|^Eff.*R.*nt$|dum.*Tim|^Arm$|BSta"
exclg.base <- "dummy[TLC]|Poo|Size|Witho|InKind|survey|^val|^Excess|^Eff.*R.*nt$|dum.*Tim|^Arm$|BSta"
exclp.base <- "With|Size|dummy[TLC]|Mode|InKind|survey|^val|^Excess|^Eff.*R.*nt$|dum.*Tim|^Arm$|BSta"
excls.base <- "Poo|Large$|Large\\.|dummy[TC]|Gra|Smal|InKind|^val|^Excess|^Eff.*R.*nt$|dum.*Tim|^Arm$|BSta"
for (jj in c("", "a", "g", "p", "s"))
{
