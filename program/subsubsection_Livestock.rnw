...
#### CLAUDE frg: 2026-05-14 FileName="NumCows" also used in subsubsection_CattleHolding.rmd
#### (lvoEN data). Do not rename either without updating both + ANCOVALivestockResults.rnw.
FileName <- "NumCows"
FileNameHeader <- c("", "PovertyStatus", "Attributes",
    "TimeVarying", "TimeVaryingAttributes")
regsuffixes <- c("", "P", "a", "T", "Ta")
