...
#### CLAUDE dea: 2026-07-16 dead line: the 7-spec regsuffixes below is
#### replaced by the 5-spec version two lines down; the first read of
#### regsuffixes (listheader <- paste0("sc", regsuffixes)) sees only 5-spec
