...
<<merge narrow prod assets, cache = F, child='c:/data/GUK/analysis/program/MergeAllNetAssetsANCOVA.rnw'>>=
...
ggsave(
  paste0(pathprogram, 
    "figure/EstimationMemo/NarrowProdAssets.png"),
  g,
...
pdf(file =  
  paste0(pathprogram, 
    "figure/EstimationMemo/NarrowProdAssets.pdf"),
...
\hfil\includegraphics[width = 12cm]{\Sexpr{    paste0(pathprogram, "figure/EstimationMemo/NarrowProdAssets.pdf")
}}\\
