...
<<DataTrimmingMembership1or4, cache = F, child='c:/data/GUK/analysis/program/DataTrimmingMembership1or4NoFlood.rnw'>>=
<<all chunks3, cache = F, child='c:/data/GUK/analysis/program/ImpactEstimation_body3.rnw'>>=
@
