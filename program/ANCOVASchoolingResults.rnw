...
\node (tbl) {\input{\Sexpr{paste0(pathsaveHere, "SchoolingANCOVAEstimationResults.tex")}}};
...
Notes: & 1. & \Sexpr{paste(TabFNAncovaTop, TabFNArm, TabFNSch, TabFN1stCol)}\\
& 2. & \Sexpr{TabFNPval}%
...
\renewcommand{\arraystretch}{.525}
\hfil\begin{tikzpicture}
\node (tbl) {\input{\Sexpr{paste0(pathsaveHere, "SchoolingAttributesANCOVAEstimationResults.tex")}}};
%\input{c:/dropbox/data/ramadan/save/tablecolortemplate.tex}
\end{tikzpicture}\\
\renewcommand{\arraystretch}{.7}
\setlength{\tabcolsep}{1pt}
...
Source:& \multicolumn{2}{l}{\scriptsize Estimated with GUK administrative and survey data.}\\
Notes: & 1. & \begin{minipage}[t]{14cm}\Sexpr{paste(TabFNAncovaTop, TabFNAttributes, TabFNSch, TabFN1stCol)} \setlength{\baselineskip}{2pt}\end{minipage}\\
& 2. & \Sexpr{TabFNPval}%
%${}^{***}$, ${}^{**}$, ${}^{*}$ indicate statistical significance at 1\%, 5\%, 10\%, respetively. Standard errors are clustered at group (village) level.
\end{tabular}
\end{minipage}
...
\hfil\begin{tikzpicture}
\node (tbl) {\input{\Sexpr{paste0(pathsaveHere, "SchoolingPovertyStatusANCOVAEstimationResults.tex")}}};
%\input{c:/dropbox/data/ramadan/save/tablecolortemplate.tex}
\end{tikzpicture}\\
...
\hspace{-1cm}\begin{tabular}{>{\hfill\scriptsize}p{1cm}<{}>{\hfill\scriptsize}p{.25cm}<{}>{\scriptsize}p{14cm}<{\hfill}}
Source:& \multicolumn{2}{l}{\scriptsize Estimated with GUK administrative and survey data.}\\
Notes: & 1. & \Sexpr{paste(TabFNAncovaTop, TabFNArm, TabFNSch, TabFNUP, TabFN1stCol)}\\
& 2. & \Sexpr{TabFNPval}%
%${}^{***}$, ${}^{**}$, ${}^{*}$ indicate statistical significance at 1\%, 5\%, 10\%, respetively. Standard errors are clustered at group (village) level.
\end{tabular}
\end{minipage}
