%  path0 <- "c:/data/GUK/"; path <- paste0(path0, "analysis/"); setwd(pathprogram <- paste0(path, "program/")); system("recycle c:/data/GUK/analysis/program/cache/ImpactEstimation2021November01/"); library(knitr); knit("ImpactEstimation2021November01.rnw", "ImpactEstimation2021November01.tex"); system("platex ImpactEstimation2021November01"); system("pbibtex ImpactEstimation2021November01"); system("dvipdfmx ImpactEstimation2021November01")
