...
%  path0 <- "c:/data/GUK/"; path <- paste0(path0, "analysis/"); setwd(pathprogram <- paste0(path, "program/")); pathsource.mar <- paste0(path, "source/mar/"); pathreceived.mar <- paste0(path0, "received/mar/"); library(knitr); knit("ImpactEstimationMembership1and4.rnw", "ImpactEstimationMembership1and4.tex"); system("platex ImpactEstimationMembership1and4"); system("dvipdfmx ImpactEstimationMembership1and4")
%  path0 <- "c:/data/GUK/"; path <- paste0(path0, "analysis/"); setwd(pathprogram <- paste0(path, "program/")); system("recycle c:/data/GUK/analysis/program/cache/ImpactEstimationMembership1and4/"); library(knitr); knit("ImpactEstimationMembership1and4.rnw", "ImpactEstimationMembership1and4.tex"); system("platex ImpactEstimationMembership1and4"); system("dvipdfmx ImpactEstimationMembership1and4")
...
opts_chunk$set(fig.path='figure/ImpactEstimationMembership1and4/', cache.path='cache/ImpactEstimationMembership1and4/', 
...
\hfil Estimating lending impacts using \textsf{membership} == 1, 3\\
...
sc2Datalist <- list(
  ...
  x2[-sc46$na.action, ],
  x2[-sc47$na.action, ])
<<Interaction between 2 or 3 matrices., warning = F>>=
