...
#  reorder estimation table according to specified order by rownames of a table
...
#  add a line next to "nextto" with a "message"
#  in a table
#  nextto: regexp
{
  #numcol <- length(unlist(strsplit(ltb[1, ], ">")) - 2)
  numcol <- ncol(tb)
...
# Depends tabs2latex, reordertab, addaseparatingline functions.
...
#  Depends: AddSubTitleInTable function.
