...
<<get jay from numcows experience covariate selection>>=
...
<<display covariates numcows experience ancova, cache = F, warning = F, eval = T, child='c:/data/GUK/analysis/program/DisplayCovariates.rnw'>>=
# source(paste0(pathprogram, "DisplayCovariates.R"))
<<numcows experience ANCOVA estimation>>=
dig.depmean <- 0
AddMeanStdColumn <- UseRawDataForDestat <- T
source(paste0(pathprogram, "ANCOVAEstimationFile2.R"))
@
<<cow holding regression by experience>>=
