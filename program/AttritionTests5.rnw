...
dir.create(paste0(pathprogram, "/AttritionTests5/"))
opts_chunk$set(fig.path='AttritionTests5/figure', cache.path='AttritionTests5/cache', cache = F, echo = T, results = 'markup', message = T)
@
...
<<Attrition Tests contents, cache = F, child='c:/data/GUK/analysis/program/AttritionTestsContents5.rnw'>>=
<<Attrition Tests main text, cache = F, child='c:/data/GUK/analysis/program/AttritionTestsMainText5.rnw'>>=
@
