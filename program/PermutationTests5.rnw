...
<<create folders, warning = F>>=
dir.create(paste0(pathprogram, "/PermutationTests5/"))
dir.create(pathsavePerm)
opts_chunk$set(fig.path='PermutationTests5/figure', cache.path='PermutationTests5/cache', cache = F, echo = T, results = 'markup', message = T)
@
...
<<Attrition Tests contents, cache = F, child='c:/data/GUK/analysis/program/PermutationTestsContents5.rnw'>>=
<<Attrition Tests main text, cache = F, child='c:/data/GUK/analysis/program/PermutationTestsMainText5.rnw'>>=
@
