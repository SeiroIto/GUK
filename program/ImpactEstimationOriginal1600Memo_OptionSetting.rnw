...
opts_chunk$set(fig.path='figure/ImpactEstimationOriginal1600Memo/', cache.path='cache/ImpactEstimationOriginal1600Memo/', 
...
pathsaveOriginal1600Memo <- paste0(pathsave, "Original1600Memo/")
