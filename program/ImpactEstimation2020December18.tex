%  path0 <- "c:/data/GUK/"; path <- paste0(path0, "analysis/"); setwd(pathprogram <- paste0(path, "program/")); system("recycle c:/data/GUK/analysis/program/cache/ImpactEstimation2020December18/"); library(knitr); knit("ImpactEstimation2020December18.rnw", "ImpactEstimation2020December18.tex"); system("platex ImpactEstimation2020December18"); system("pbibtex ImpactEstimation2020December18"); system("dvipdfmx ImpactEstimation2020December18")
...
\myquote{These results show that the costs of microfinance programs targeted to the ultra poor can be reduced by using loans and charging fees. Use of loans and fees can increase the likelihood of long run viability often overlooked in transfer programs. }
\end{enumerate}
Experimental design:
\begin{enumerate}
\vspace{1.0ex}\setlength{\itemsep}{1.0ex}\setlength{\baselineskip}{12pt}
