...
opts_chunk$set(fig.path='figure/ImpactEstimationMembership1or4/', cache.path='cache/ImpactEstimationMembership1or4/', 
...
pathsavemembership1or4 <- paste0(pathsave, "membership1or4/")
