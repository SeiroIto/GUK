...
opts_chunk$set(
fig.path='figure/ImpactEstimationOriginal1600Memo2/', 
cache.path='cache/ImpactEstimationOriginal1600Memo2/', 
...
pathsaveOriginal1600Memo2 <- paste0(pathsave, "Original1600Memo2/")
