...
# Drop all num == 1 except for NumCows and NumCowsAdi, NumCowsNone, NumCowsOwn, 
confi <- confi[grepl("NumCows", FileName) | (!grepl("NumCows", FileName) & num != 1), ]
...
confi[grepl("Con", FileName) & regtype=="T" & grepl("ge$", attributes) & grepl("sum", ImpactType), ]
