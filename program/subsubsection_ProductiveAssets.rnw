<<merge prod assets, cache = F, child='c:/data/GUK/analysis/program/MergeAllNarrowNetAssetsANCOVA.rnw'>>=
...
ggsave(
  paste0(pathprogram, 
    "EstimationMemo/figure/ProdAssets.png"),
  g,
...
\hfil\includegraphics[width = 12cm]{\Sexpr{    paste0(pathprogram, "EstimationMemo/figure/ProdAssets.png")
}}\\
