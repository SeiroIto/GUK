...
ggsave(
  paste0(pathprogram, 
    "figure/EstimationMemo/CompletePanelProdAssets.png"),
  g,
...
pdf(file =  
  paste0(pathprogram, 
    "figure/EstimationMemo/CompletePanelProdAssets.pdf"),
...
\hfil\includegraphics[width = 12cm]{\Sexpr{    paste0(pathprogram, "figure/EstimationMemo/CompletePanelProdAssets.pdf")
}}\\
