...
exclDG.base <- "^PureCo|^credit|^dummy[FTLCS]|.Size|Poo|Witho|InKind|Cash|^Arm$|BSta"
excla.base <- "^PureCo|^credit|dummy[TC]|Large$|Large\\.|LargeG|Witho|Poor|Small|^Arm$|BSta"
...
for (a in Assuffixes) {
  if (a != "S" & !grepl("D", a)) {
    ...
    assign(paste0("excl", a, 5), "Floo|RM|Eff|Head|0$")
    ...
    assign(paste0("excl", a, 4), "DUMMYSTRING")
    assign(paste0("excl", a, 5), "Floo|RM|Head|0$")
