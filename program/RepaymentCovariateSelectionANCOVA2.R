...
excl.base <- paste0("Size|Poo|With|InK|Cash|Trad|LY|", common.excl)
excla.base <- paste0("dummy[TC]|rge$|rge[\\.G]|Witho|Poor|Small|Cows.C|LY|",
  common.excl)
exclP.base <- paste0("dummy[CMST]|rge$|rge[\\.G]|Witho|Cows.C|LY|",
  common.excl)
exclT.base <- gsub("LY", "LY2", excl.base)
exclTa.base <- gsub("LY", "LY2", excla.base)
exclTP.base <- "Pure|UD|Mod|Siz|Wi|InK|Cash|Cattle|Tra|LY.?2"
exclTPa.base <- gsub("LY", "LY2", exclP.base)
