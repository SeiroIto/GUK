...
\node (startnode) {\mpage{5cm}{\hfil Pre-acceptance ($g=80$, $n=800$)\\\\[-1ex]\mpage{5cm}{\footnotesize\hfill moderately poor (240)\\\hfill ultra poor (560)\SetLengthSkip{10pt}}\SetLengthSkip{10pt}}};
