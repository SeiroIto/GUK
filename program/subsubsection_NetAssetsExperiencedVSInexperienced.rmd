...
* `r paste0(DataFileNames[4], "Trimmed.rds")` (assets) + `r paste0(DataFileNames[11], "Trimmed.rds")` (debts) + `r paste0(DataFileNames[2], "Trimmed.rds")` (admin data) + paste0(DataFileNames[5], "InitialSample.rds") (livestock) &rArr; `NeA1R` data.  
