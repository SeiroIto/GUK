<<merge prod assets livestock, cache = F, child='c:/data/GUK/analysis/program/MergeAllNarrowNetAssetsANCOVA.rnw'>>=
...
ggsave(
  paste0(pathprogram, 
    "EstimationMemo/figure/ProdAssetLivestock.png"),
  g,
...
\hfil\includegraphics[width = 12cm]{\Sexpr{    paste0(pathprogram, "EstimationMemo/figure/ProdAssetLivestock.png")
}}\\
