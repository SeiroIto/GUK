...
%\Sexpr{knit_child(paste0(pathprogram, "Intro1.rnw"))}
...
\Sexpr{knit_child(paste0(pathprogram, "Intro2.rnw"))}
...
% \hspace{-1cm}\input{\Sexpr{paste0(pathprogram, "GUK_RCTDesignDiagram.tex")}}
% \end{adjustbox}
