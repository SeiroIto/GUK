...
<<net assets merge assets livestock saving data for est and figure, cache = F, child='c:/data/GUK/analysis/program/MergeAllNarrowNetAssetsANCOVA.rnw'>>=
...
library(ggplot2)
# MergeAllNarrowNetAssetsANCOVA.rnw
