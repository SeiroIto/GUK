...
<<all chunks0, cache = F, child='c:/data/GUK/analysis/program/ImpactEstimationOriginal1600Memo2_OptionSetting.rnw'>>=
<<>>=
# Only change the trimming conditions to switch between "1 or 4" to "NoFlood"
ThisIsNoFlood <- F
if (ThisIsNoFlood) 
  pathsaveHere <- pathsaveNoFlood else 
  pathsaveHere <- pathsaveOriginal1600Memo2
...
<<all chunks1, cache = F, child='c:/data/GUK/analysis/program/ImpactEstimationOriginal1600Memo2_body1.rnw'>>=
# Below reads from folder pathsaveOriginal1600Memo2 and 
# saves with XXXAdminDataUsedForEstimation.rds in 
# folder pathsaveOriginal1600Memo3
<<DataTrimmingOriginal1600, cache = F, child='c:/data/GUK/analysis/program/DataTrimmingOriginal1600Memo2.rnw'>>=
# Below reads from folder pathsaveOriginal1600Memo3 and 
# XXXAdminDataUsedForEstimation.rds and estimates. 
<<original HH regressions, eval = T, cache = F, child='c:/data/GUK/analysis/program/ImpactEstimationOriginal1600Memo2_body3.rnw'>>=
@
\end{document}
