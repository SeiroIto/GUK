...
\hfil\includegraphics{\Sexpr{  paste0(pathprogram, "EstimationMemo/figure/LandHoldingScatterWithZero.png")}}\\
\renewcommand{\arraystretch}{1}
\hfil\begin{tabular}{>{\hfill\scriptsize}p{1cm}<{}>{\scriptsize}p{12cm}<{\hfill}}
Source: & Survey data.\\
...
\hfil\includegraphics{\Sexpr{  paste0(pathprogram, "EstimationMemo/figure/LandHoldingScatterWithoutZero.png")}}\\
\renewcommand{\arraystretch}{1}
\hfil\begin{tabular}{>{\hfill\scriptsize}p{1cm}<{}>{\scriptsize}p{12cm}<{\hfill}}
Source: & Survey data.\\
...
\hfil\includegraphics{\Sexpr{  paste0(pathprogram, "EstimationMemo/figure/", "LandHoldingHistogramByRound.png")}}\\
\renewcommand{\arraystretch}{1}
\hfil\begin{tabular}{>{\hfill\scriptsize}p{1cm}<{}>{\scriptsize}p{12cm}<{\hfill}}
Source: & Survey data.\\
...
\hfil\includegraphics{\Sexpr{  paste0(pathprogram, "EstimationMemo/figure/", "LandHoldingHistogramByRoundRealValues.png")}}\\
\renewcommand{\arraystretch}{1}
\hfil\begin{tabular}{>{\hfill\scriptsize}p{1cm}<{}>{\scriptsize}p{12cm}<{\hfill}}
Source: & Survey data.\\
